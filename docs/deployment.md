...
__ctrl__\fast-next-ctrl.bat pubkey
...
```bat
__ctrl__\fast-next-ctrl.bat update
__ctrl__\fast-next-ctrl.bat status
__ctrl__\fast-next-ctrl.bat stop
__ctrl__\fast-next-ctrl.bat backup-acme
```
...
```bat
__ctrl__\fast-next-ctrl.bat prod start
```
