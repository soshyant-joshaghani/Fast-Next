...
Fast-Next UI primitives are **shadcn/ui** under `frontend/src/lib/modules/base/ui/` (`@/lib/modules/base/ui/`). Use those for buttons, cards, tables, sheets, sidebar, and form controls. Keep the dashboard shell in `modules/base/`.
