...
fast-next uses **Redis + ARQ** as the standard background processing path. This is the only queue system — do not add Celery, RQ, or parallel worker architectures.
...
Worker console title: `fast-next-worker` (Windows).
