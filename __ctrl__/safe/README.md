...
| `*-env.env` | Production secrets → uploaded as `~/projects/fast-next/.env` |

| Files | Server id |
|-------|-----------|
| `ar-fast-next-bamdad-*` | `fast-next` |
...
That copies `safe/ar-fast-next-bamdad-env.env` → `~/projects/fast-next/.env`.
