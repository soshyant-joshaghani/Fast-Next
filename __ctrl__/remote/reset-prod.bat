...
for %%V in (fast-next_db-data fast-next_redis-data) do (
...
for %%I in (fast-next-backend:prod fast-next-frontend:prod) do (
...
echo.
echo Start fresh: fast-next-ctrl.bat prod start
endlocal
